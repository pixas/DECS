...
class DataParallelPPOActor(BasePPOActor):
    ...
    def compute_log_prob_entropy(self, data: DataProto) -> DataProto:
        """Compute the logprob and  entropy of the responses given input_ids, attention_mask and position_ids
